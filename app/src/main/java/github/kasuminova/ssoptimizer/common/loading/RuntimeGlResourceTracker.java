...
public final class RuntimeGlResourceTracker {
    ...
    private static boolean isFileBackedMarker(final String className) {
        return "github.kasuminova.ssoptimizer.common.loading.TextureUploadHelper".equals(className)
                || "github.kasuminova.ssoptimizer.common.loading.LazyTextureManager".equals(className)
    ...
    private static boolean shouldIgnoreOwnerFrame(final String className) {
        return className == null
                ...
                || className.startsWith("github.kasuminova.ssoptimizer.common.loading.TextureUploadHelper")
                || className.startsWith("github.kasuminova.ssoptimizer.common.loading.LazyTextureManager");
    }

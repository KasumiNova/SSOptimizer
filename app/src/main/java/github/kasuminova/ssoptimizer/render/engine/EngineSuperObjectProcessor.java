...
public final class EngineSuperObjectProcessor implements AsmClassProcessor {
    ...
    static final String HELPER_OWNER =
            "github/kasuminova/ssoptimizer/render/engine/SuperObjectRenderHelper";
    static final String LAYOUT_HELPER_OWNER =
        "github/kasuminova/ssoptimizer/render/engine/TextLayoutDiagnostics";
    static final String FONT_SWAP_HELPER_OWNER =
        "github/kasuminova/ssoptimizer/font/RuntimeScaledFontCache";

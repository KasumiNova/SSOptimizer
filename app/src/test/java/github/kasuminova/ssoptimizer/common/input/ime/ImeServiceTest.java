...
class ImeServiceTest {
    ...
    private static final class FakeImeBackend implements ImeBackend {
        ...
        @Override
        public void attach(long display, long window) {
        }
        ...
        @Override
        public void updateSpot(ImeCaretRect rect) {
            lastSpot = rect;
        }

        @Override
        public boolean onX11KeyEvent(long keyEventAddress, int eventType) {
            return false;
        }
        ...
        @Override
        public boolean filterXimProtocolEvent(long eventAddress) {
            return false;
        }
    }
    ...
    private static final class FakeTextField implements TextFieldAPI {
        ...
        @Override
        public boolean appendCharIfPossible(char var1) {
            this.text += var1;
            this.label.text += var1;
            return true;
        }
        ...
        @Override
        public boolean isLimitByStringWidth() {
            return false;
        }

        @Override
        public void setLimitByStringWidth(boolean var1) {
        }

        @Override
        public boolean appendCharIfPossible(char var1, boolean var2) {
            return appendCharIfPossible(var1);
        }
        ...
        @Override
        public void grabFocus(boolean var1) {
        }

        @Override
        public boolean isUndoOnEscape() {
            return false;
        }

        @Override
        public void setUndoOnEscape(boolean var1) {
        }

        @Override
        public boolean isHandleCtrlV() {
            return false;
        }

        @Override
        public void setHandleCtrlV(boolean var1) {
        }
        ...
        @Override
        public boolean isVerticalCursor() {
            return true;
        }

        @Override
        public void setVerticalCursor(boolean var1) {
        }
        ...
        @Override
        public void processInput(List<InputEventAPI> var1) {
        }
    ...
    private static final class FakePosition implements PositionAPI {
        ...
        @Override
        public PositionAPI setLocation(float var1, float var2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public PositionAPI setSize(float var1, float var2) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        public PositionAPI setXAlignOffset(float var1) {
            return this;
        }

        @Override
        public PositionAPI setYAlignOffset(float var1) {
            return this;
        }

        @Override
        public PositionAPI inTL(float var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI inTMid(float var1) {
            return this;
        }

        @Override
        public PositionAPI inTR(float var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI inRMid(float var1) {
            return this;
        }
        ...
        @Override
        public PositionAPI inBR(float var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI inBMid(float var1) {
            return this;
        }

        @Override
        public PositionAPI inBL(float var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI inLMid(float var1) {
            return this;
        }

        @Override
        public PositionAPI leftOfTop(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI leftOfMid(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI leftOfBottom(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI rightOfTop(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI rightOfMid(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI rightOfBottom(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI aboveLeft(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI aboveMid(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI aboveRight(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI belowLeft(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI belowMid(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }

        @Override
        public PositionAPI belowRight(com.fs.starfarer.api.ui.UIComponentAPI var1, float var2) {
            return this;
        }
        ...
        @Override
        public void setSuspendRecompute(boolean suspendRecompute) {
            this.suspendRecompute = suspendRecompute;
        }
    }
    ...
    private static final class FakeLabel implements LabelAPI {
        ...
        @Override
        public float computeTextWidth(String var1) {
            return width;
        }

        @Override
        public float computeTextHeight(String var1) {
            return position.getHeight();
        }

        @Override
        public void setHighlight(int var1, int var2) {
        }

        @Override
        public void highlightFirst(String var1) {
        }

        @Override
        public void highlightLast(String var1) {
        }
        ...
        @Override
        public void unhighlightIndex(int var1) {
        }
        ...
        @Override
        public void setHighlightColors(Color... var1) {
        }
        ...
        @Override
        public void italicize(float var1) {
        }
        ...
        @Override
        public PositionAPI autoSizeToWidth(float var1) {
            return position;
        }

        @Override
        public void flash(float var1, float var2) {
        }

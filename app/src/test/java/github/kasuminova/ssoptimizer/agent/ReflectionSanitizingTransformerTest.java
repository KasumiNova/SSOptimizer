...
class ReflectionSanitizingTransformerTest {
    ...
    @Test
    void skipOwnPackage() {
        byte[] dummy = createDummyClass("github/kasuminova/ssoptimizer/agent/Foo");
        assertNull(transformer.transform(null, "github/kasuminova/ssoptimizer/agent/Foo", null, null, dummy));
    }
    ...
    void rewritesNonGameClassesWhenReflectionCallsExist() {
        ...
        assertTrue(containsInvokeStatic(result, "github/kasuminova/ssoptimizer/agent/ReflectionHelper", "getMethod"));
    }
    ...
    void rewritesGetDeclaredFieldCall() {
        ...
        assertTrue(containsInvokeStatic(result, "github/kasuminova/ssoptimizer/agent/ReflectionHelper", "getDeclaredField"));
    }
    ...
    void rewritesGetDeclaredMethodCall() {
        ...
        assertNotNull(result);
        assertTrue(containsInvokeStatic(result, "github/kasuminova/ssoptimizer/agent/ReflectionHelper", "getDeclaredMethod"));
    }
    ...
    void rewritesGetFieldCall() {
        ...
        assertNotNull(result);
        assertTrue(containsInvokeStatic(result, "github/kasuminova/ssoptimizer/agent/ReflectionHelper", "getField"));
    }
